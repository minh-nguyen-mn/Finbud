...
web.layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            ], placeholder='Select Stock', style={'width': '80%', 'margin': '0s auto'}),
        ...
        ], id="main-content", className="panel"),
    ...
    html.Div([
        ...
        ], id="main-content2", className="panel"),
    ...
    ], className="Panels", style={'width': '80%', 'margin': '0 auto'})
], className="container")
...
web.run_server(debug=True, port=8050)
